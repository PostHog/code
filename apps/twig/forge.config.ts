...
const config: ForgeConfig = {
  packagerConfig: {
    asar: {
      unpack:
        "{**/*.node,**/spawn-helper,**/.vite/build/claude-cli/**,**/.vite/build/claude-code/posthog/**,**/.vite/build/codex-acp/**,**/node_modules/node-pty/**,**/node_modules/@parcel/**,**/node_modules/file-icon/**}",
    },
    prune: false,
    name: "Twig",
    executableName: "Twig",

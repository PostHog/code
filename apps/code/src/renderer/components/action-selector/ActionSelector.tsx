  ...
  return (
    ...
    >
      <Flex direction="column" gap="2">
        ...
        {title && (
          <Text
            className="font-medium text-[13px] text-blue-11 leading-5"
            title={title}
          >
        ...
        <Box>
          <Text mb="2" as="p" className="text-[13px] leading-5">
            {question}
          </Text>
          ...
          <Text color="gray" mt="2" as="p" className="text-[13px] leading-5">

...
const SOURCE_PRODUCT_COLORS: Record<string, string> = {
  error_tracking: "var(--red-9)",
  session_replay: "var(--amber-9)",
  llm_analytics: "var(--purple-9)",
  github: "var(--gray-11)",
  linear: "var(--blue-9)",
  zendesk: "var(--green-9)",
};
...
function sourceProductColor(product: string): string {
  return SOURCE_PRODUCT_COLORS[product] ?? "var(--gray-9)";
}

...
import { ChiefOfStaffDialog } from "../chief-of-staff/ChiefOfStaffDialog";
...
export function AutomationsView() {
  ...
  const [chiefOfStaffOpen, setChiefOfStaffOpen] = useState(false);
    ...
    <Flex direction="column" height="100%" className="overflow-hidden">
      ...
      >
        ...
        <Button
          ...
          variant="soft"
          color="orange"
          onClick={() => setChiefOfStaffOpen(true)}
        >
          <MagicWand size={12} />
          Chief of Staff
        </Button>
      ...
      <ChiefOfStaffDialog
        open={chiefOfStaffOpen}
        onOpenChange={setChiefOfStaffOpen}
      />
    </Flex>
  );
}

...
import type { Automation, AutomationTemplate } from "@shared/types/automations";
...
interface AutomationStoreState {
  ...
  userTemplates: AutomationTemplate[];
...
interface AutomationStoreActions {
  ...
  addUserTemplates: (templates: AutomationTemplate[]) => void;
}

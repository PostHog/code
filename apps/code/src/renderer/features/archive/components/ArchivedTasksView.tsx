      ...
      <Box className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <Flex align="center" justify="center" py="8">
            <Text className="text-[12px] text-gray-10">No archived tasks</Text>
          </Flex>
        ) : (
          <Table.Root
            size="1"
          ...
          >
            <Table.Header>
              <Table.Row>
                <Table.ColumnHeaderCell className="font-normal text-[12px] text-gray-11">
                  Title
                ...
                >
                  <Table.Cell>
                    <Flex align="center" gap="2">
                      ...
                      <Text className="block max-w-[600px] truncate text-[12px]">
                        {item.task?.title ?? "Unknown task"}
                      </Text>
                    </Flex>
                  </Table.Cell>
                  <Table.Cell>
                    <Text className="block whitespace-nowrap text-[12px] text-gray-11">
                      {formatRelativeDate(item.task?.created_at)}
                    </Text>
                  </Table.Cell>
                  <Table.Cell>
                    <Text className="block max-w-[300px] truncate text-[12px] text-gray-11">

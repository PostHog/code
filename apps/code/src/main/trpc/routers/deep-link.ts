...
export const deepLinkRouter = router({
  ...
  /**
   * Subscribe to new-task deep link events. Emits when posthog-code://new?prompt=...
   * is opened so the renderer can prefill or auto-create a task.
   */

...
import { PosthogCodeMcpService } from "../services/posthog-code-mcp/service";
...
container.bind(MAIN_TOKENS.PosthogCodeMcpService).to(PosthogCodeMcpService);
container.bind(MAIN_TOKENS.PreviewService).to(PreviewService);
container.bind(MAIN_TOKENS.ScratchpadService).to(ScratchpadService);
